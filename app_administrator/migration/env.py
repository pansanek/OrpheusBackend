...
from app_administrator.app.schemas.administrator_schema import Administrator
from app_administrator.app.schemas.base_schema import Base
...
# ... etc.
from app_user.app.settings import settings
