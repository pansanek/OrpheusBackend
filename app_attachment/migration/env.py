...
from app_attachment.app.schemas.attachment_schema import Attachment
from app_attachment.app.schemas.base_schema import Base
...
# ... etc.
from app_attachment.app.settings import settings
